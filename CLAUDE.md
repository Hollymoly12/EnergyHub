...
- Style : Tailwind + classes custom dans globals.css (btn-primary, btn-secondary, card, input, label, section-tag)
- Couleurs : bg surface (#080C14, #0D1520, #1E293B, #334155) + brand (amber #F59E0B, green #4ADE80, purple #818CF8, red #EF4444)
- Typo : font-display (Syne) pour titres, font-body (DM Sans) pour texte
...
- ⏳ RLS Supabase désactivé temporairement (à réactiver)
- ⏳ Stripe en mode test
